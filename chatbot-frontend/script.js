...
let response="";
    $.ajax({
                ...
                error: function() {
                    let response = "Could you be more specific please.";
                    text = text.toLowerCase();
                    if(text == 'hi' || text == 'hello'){
                      response = "How are you feeling today ?";
                    }
                    if(text.includes('okay') || text.includes('low') || text.includes('not')){
                      response = 'I understand. Seems like something bothering you.\n Could you further describe it, in short?';
                    }
                    if(text.includes('good')){
                      response = 'Happy to hear. I am always there if you need anything';
                     }
                   if(text.includes('related')){
                      response = 'It seems like though the issue might be a little worrisome, it might not actually be very serious.\nWhat are your thoughts on this?\n';
                    }
                    if(text.includes('yeah') || text.includes('could')){
                      response = 'Looks like you agree with me. Dont take too much stress.\nI would like to suggest you a few things to help you feel better, if you dont mind ?';
                    }
                    if(text.includes('sure')){
                      response = 'All you need to do is adjust your priorities.\nDont take on unnecessary duties and responsibilities.\n You should have clear boundaries between your work life and home life so you make sure that you dont mix them.\nYou could try Techniques such as meditation and deep breathing. These can be really helpful in relieving stress.\n';
                    }
                    if(text.includes('thanks')){
                          response = 'Any time. Happy to help. \nSigning off ! Mood Elevator';
                        }
                    adminSend(response);
                }
            });
